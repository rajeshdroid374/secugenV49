...
import 'package:secugen_v_4_9_plugin/utils/constants.dart';
...
/// An implementation of [SecugenV49PluginPlatform] that uses method channels.
class MethodChannelSecugenV49Plugin extends SecugenV49PluginPlatform {
...
SecugenV49Exception _libException(PlatformException exception) {

  SecugenV49Exception sgfplibException = SecugenV49Exception();
